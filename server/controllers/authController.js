    ...
    try {
        ...
        if (!firebaseInitialized) {
            return res.status(500).json({
                success: false,
                message: 'Firebase chưa được cấu hình. Vui lòng liên hệ quản trị viên.'
            });
        }

        // Note: In production, you should implement rate limiting here
        // to prevent OTP spam

        // Firebase Auth handles OTP sending on the client side
        // This endpoint mainly validates the phone number format
