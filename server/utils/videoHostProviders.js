...
const seekstreamingAPI = process.env.SEEKSTREAMING_API_KEY 
    ? new PremiumHostService('Seekstreaming (VIP 1)', process.env.SEEKSTREAMING_API_URL || 'https://seekstreaming.com', process.env.SEEKSTREAMING_API_KEY, process.env.SEEKSTREAMING_EMBED_BASE || 'https://pchill-seek.online/#') 
    : null;
